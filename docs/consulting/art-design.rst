...
FoxDot
~~~~~~~
| Web: https://foxdot.org/
| Src: https://github.com/Qirky/FoxDot
| Src: https://gitlab.com/iShapeNoise/foxdot
| Docs: https://foxdot.org/docs/
| Docs: https://foxdot.org/docs/pattern-basics/

FoxDot is an :ref:`open source` :ref:`Live Coding`
language and editor
for realtime, concurrent :ref:`musical composition` :ref:`audio synthesis`
written in :ref:`Python`
that runs on :ref:`SuperCollider`.

* FoxDot supports "On the Fly Programming":
  code and loops can be changed while
  the FoxDot program is running in :ref:`SuperCollider`
* The iShapeNoise/foxdot "PitchGlitch" fork of FoxDot is
  actively maintained, and has a different ``README``:
...
EQ
---
| Wikipedia: `<https://en.wikipedia.org/wiki/Equalization_(audio)>`__

Audio equalization with an equalizer (EQ)
is the process of adjusting the amplitude
of a waveform at one or more frequencies.

- A Graphic Equalizer ("Graphic EQ")
  maps the waveform and/or the EQ parameters
  to visual signals for visualization
- A Parametric Equalizer ("Parametric EQ")
  allows control of: 

  - Amplitude or "boost" or "cut" (:ref:`decibels <dB>` of gain)
...
- BP: Band-pass filter
- Shelving filter
- First-order filters (can be implemented with resistor and capacitor)
- Second-order filters (have a Q parameter)
...
BespokeSynth
-------------
| Wikipedia: https://en.wikipedia.org/wiki/BespokeSynth
| Web: https://www.bespokesynth.com/
| Src: https://github.com/BespokeSynth/BespokeSynth/

BespokeSynth is an :ref:`open source` app
for :ref:`live coding` and :ref:`modular synthesis`
written in :ref:`C` and :ref:`C++`

- audinux has a build of BespokeSynth:

  - | Web: https://copr.fedorainfracloud.org/coprs/ycollet/audinux/package/BespokeSynth/
  - | Src: https://copr-dist-git.fedorainfracloud.org/cgit/ycollet/audinux/BespokeSynth.git/tree/bespokesynth.spec
  - | Src: https://github.com/audinux/fedora-spec/blob/master/bespokesynth/bespokesynth.spec
  - | Src: https://github.com/audinux/fedora-spec/blob/master/bespokesynth/bespokesynth-weekly.spec
...
is a :ref:`DAW`, :ref:`MIDI` sequencer and video editing software
written in :ref:`C`, :ref:`C++`, and :ref:`ASM`.
...
* :ref:`PipeWire` supports :ref:`JACK`
...
an :ref:`open standard` for audio filters and effects
written in :ref:`C`.
...
LV2
~~~~
| Wikipedia: https://en.wikipedia.org/wiki/LV2
| Source: https://gitlab.com/lv2/lv2

LV2 (:ref:`LADSPA` version 2) is an :ref:`open standard`
for audio filters and effects
written in :ref:`C` and Turtle.

* :ref:`Ardour`, :ref:`Audacity`, and
  :ref:`BespokeSynth`
  all support LV2
...
| Web: https://www.steinberg.net/developers/

VST2 and VST3 are a reusable audio transform APIs for :ref:`Audio Synthesis`
and :ref:`Sound Production` tools by Steinberg.

* A VST plugin is a :ref:`packaged <packages>` module
  of instruments, effects, and/or :ref:`MIDI` code
* A VST host is a program which can run VST plugins (VST2, VST3)

  * :ref:`Ardour`
  * :ref:`Audacity`
  * :ref:`BespokeSynth`
  * ACID, Adobe Premiere, Cakewalk, FL Studio, Sound Forge, Vegas
  * Bridges: Carla, Yabridge
...
.. note:: :ref:`PipeWire` supersedes :ref:`PulseAudio`, and then
   PulseAudio tools work with PipeWire.
...
| Web:  https://pipewire.org/

PipeWire is an :ref:`open source` realtime sound and video server.

- :ref:`PulseAudio` tools work with PipeWire
- :ref:`ALSA` tools like ``alsamixer`` work with PipeWire
- :ref:`JACK` tools work with PipeWire

...
| Docs: https://rosettacode.org/wiki/Tree_traversal
...
| Docs: https://www.tldp.org/HOWTO/LVM-HOWTO/index.html
| Docs: https://www.tldp.org/HOWTO/LVM-HOWTO/anatomy.html
...
| Docs: https://libfuse.github.io/doxygen/
...
| Docs: https://docs.ceph.com/docs/master/
| Docs: https://docs.ceph.com/docs/master/rados/
| Docs: https://docs.ceph.com/docs/master/radosgw/
| Docs: https://docs.ceph.com/docs/master/radosgw/s3/
| Docs: https://docs.ceph.com/docs/master/radosgw/swift/
| Docs: https://docs.ceph.com/docs/master/radosgw/keystone/
| Docs: https://docs.ceph.com/docs/master/rbd/rbd-openstack/
...
| Source: https://github.com/gluster/glusterfs
...
* https://cwe.mitre.org/top25/#CWE-89 (#1 Most Prevalent Dangerous
  Security Error (2011))
...
| Docs: https://www.postgresql.org/docs/12/index.html
| Docs: https://www.postgresql.org/docs/12/sql.html
...
| Docs: http://docs.openlinksw.com/virtuoso/virtuosospongerusage/
...
| Download: https://www.blazegraph.com/download
| Src: https://github.com/blazegraph/database
| Docs: https://www.blazegraph.com/learn
| Docs: https://www.blazegraph.com/inference
| Docs: https://www.blazegraph.com/blueprints
| Docs: https://www.blazegraph.com/sesame
| Docs: https://www.blazegraph.com/develop
| Docs: https://www.blazegraph.com/docs/api/
...
| Docs: https://research.google.com/archive/bigtable.html
...
Apache Beam is an open source batch and streaming
parallel data processing framework with support for
Apache Apex, Apache Flink, `Apache Spark`_, and Google Cloud Dataflow. 
...
| Docs: https://docs.datastax.com/en/cassandra-oss/3.x/
| Docs: https://docs.datastax.com/en/cassandra-oss/3.x/cassandra/architecture/archIntro.html
...
| Docs: https://hadoop.apache.org/docs/current/
...
* There are many software libraries for implementing REST API Servers:
  ...
  * Python: Django REST Framework:
    ...
    | Src: https://github.com/encode/django-rest-framework
...
* There are many software libraries for implementing REST API Clients:
  ...
  * Python REST API client libraries:
    ...
    * requests:
      ...
      | Src: https://github.com/psf/requests
...
| Docs: https://wamp-proto.org/why/
| Docs: https://wamp-proto.org/faq/
| Docs: https://wamp-proto.org/implementations/
...
* Implementations:
  ...
  * https://wamp-proto.org/implementations/
...
| Source: https://github.com/apache/lucene-sol
...
| Docs: https://xapian.org/docs/
| Docs: https://xapian.org/docs/apidoc/html/inherits.html
...
| Docs: https://nlp.stanford.edu/IR-book/information-retrieval.html
...
(from `<https://en.wikipedia.org/wiki/Time_in_the_United_States#Daylight_saving_time_(DST)>`__):
...
+----------+--------------------+------------------+
| 2021     | 2019-03-14 02:00   | 2019-11-07 02:00 |
+----------+--------------------+------------------+
| 2022     | 2020-03-13 02:00   | 2020-11-06 02:00 |
+----------+--------------------+------------------+
| 2023     | 2019-03-12 02:00   | 2019-11-05 02:00 |
+----------+--------------------+------------------+
| 2024     | 2020-03-10 02:00   | 2020-11-03 02:00 |
+----------+--------------------+------------------+
| 2025     | 2019-03-09 02:00   | 2019-11-02 02:00 |
+----------+--------------------+------------------+
| 2026     | 2020-03-08 02:00   | 2020-11-01 02:00 |
+----------+--------------------+------------------+
| 2027     | 2019-03-14 02:00   | 2019-11-07 02:00 |
+----------+--------------------+------------------+
| 2028     | 2020-03-12 02:00   | 2020-11-05 02:00 |
+----------+--------------------+------------------+
| 2029     | 2019-03-11 02:00   | 2019-11-04 02:00 |
+----------+--------------------+------------------+
...
| Standard: https://www.iso.org/iso/iso8601
...
* The ``date`` command can print :ref:`iso8601` -compatible
  ...
  .. code:: bash
      ...
      $ date -Iseconds --utc  # GNU date
      2020-03-26T03:35:24+00:00
...
| Homepage: https://www.pool.ntp.org/en/
...
* https://www.w3.org/2001/sw/wiki/Books
...
| Standard: https://tools.ietf.org/html/rfc7230#page-5
...
HTTP in RDF
`````````````
| Standard: https://www.w3.org/TR/HTTP-in-RDF10/
| Namespace: `<https://www.w3.org/2011/http#>`__
| Namespace: `<https://www.w3.org/2011/http-headers> .`__
| Namespace: `<https://www.w3.org/2011/http-methods> .`__
| Namespace: `<https://www.w3.org/2011/http-statusCodes> .`__
| xmlns: ``@prefix http: <https://www.w3.org/2011/http#> .``
| xmlns: ``@prefix http-headers: <https://www.w3.org/2011/http-headers> .``
| xmlns: ``@prefix http-methods: <https://www.w3.org/2011/http-methods> .``
| xmlns: ``@prefix http-statusCodes: <https://www.w3.org/2011/http-statusCodes> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/http
...
| Homepage: https://www.webrtc.org/
| Standard: https://tools.ietf.org/wg/rtcweb/
...
.. note:: WebRTC is supported by most browsers:
...
HTML4
```````
| Standard: https://www.w3.org/TR/html4/
...
| Standard: https://www.w3.org/TR/xhtml2/
...
| Standard: https://www.w3.org/TR/xml/
...
| Standard: https://www.w3.org/TR/xmlschema11-2/
| Namespace: `<https://www.w3.org/2001/XMLSchema#>`__
| xmlns: ``@prefix xsd: <https://www.w3.org/2001/XMLSchema#> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/xsd
...
| Namespace: `<https://www.w3.org/ns/csvw#>`__
...
| xmlns: ``@prefix rdf: <https://www.w3.org/1999/02/22-rdf-syntax-ns#> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/rdf
...
* https://www.w3.org/TR/rdf11-primer/#section-vocabulary
...
* https://www.w3.org/TR/rdf11-concepts/#section-html
...
RDF Interfaces
````````````````
| Standard: https://www.w3.org/TR/rdf-interfaces/
| Docs: https://www.w3.org/TR/rdf-interfaces/#high-level-api
  ...
  .. note:: rdflib is not order-preserving at this time,
     ...
     * ``rdf:List`` are ordered.
       ...
       * ``rdf:List`` with :ref:`JSON-LD` ``@context``:
         ...
         * https://www.w3.org/TR/json-ld/#lists-and-sets
...
| Standard: https://www.w3.org/TR/n-triples/
| Extension: ``.nt``
...
| Standard: https://www.w3.org/TR/rdf-syntax-grammar/
| Extension: ``.rdf``
...
* https://www.w3.org/2004/03/trix/rdfg-1/
...
| Standard: https://www.w3.org/TR/trig/
| Extension: ``.trig``
...
| Homepage: https://www.w3.org/2001/sw/wiki/RDFa
| Standard: https://www.w3.org/TR/rdfa-core/
| Standard: https://www.w3.org/TR/rdfa-lite/
| Standard: https://www.w3.org/TR/html-rdfa/
| Standard: https://www.w3.org/TR/rdfa-syntax/
| Standard: https://www.w3.org/2011/rdfa-context/rdfa-1.1
| Docs: https://www.w3.org/TR/rdfa-primer/
...
```````````````````````
| Standard: https://www.w3.org/2011/rdfa-context/rdfa-1.1
| Standard:  https://www.w3.org/2013/json-ld-context/rdfa11
...
| Standard: https://www.w3.org/TR/rdf-schema/
| Namespace: `<https://www.w3.org/2000/01/rdf-schema#>`__
| xmlns: ``@prefix rdfs: <https://www.w3.org/2000/01/rdf-schema#> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/rdfs
...
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/dcterms
| Namespace: http://purl.org/dc/dcmitype/
| xmlns: ``@prefix dctypes: <http://purl.org/dc/dcmitype/> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/dctype
...
| Namespace: `<https://www.w3.org/ns/earl#>`__
| xmlns: ``@prefix earl: https://www.w3.org/ns/earl#``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/earl
...
* The JSON-LD Implementation test results are expressed with EARL:
  ...
  | https://json-ld.org/test-suite/reports/
...
RDF Data Cubes
```````````````
| Standard: https://www.w3.org/TR/vocab-data-cube/
| Namespace: `<http://purl.org/linked-data/cube#>`__
| xmlns: ``@prefix qb: <http://purl.org/linked-data/cube#> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/qb
...
| Standard: https://www.w3.org/TR/skos-reference/
| Standard: https://www.w3.org/TR/skos-reference/skos.html
| Namespace: `<https://www.w3.org/2004/02/skos/core#>`_
| xmlns: ``@prefix skos: <https://www.w3.org/2004/02/skos/core#> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/skos
...
XKOS
``````
| Homepage: https://ddialliance.org/Specification/RDF/XKOS
...
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/xkos
...
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/foaf
...
| Namespace: `<https://www.w3.org/ns/shacl#>`__
| xmlns: ``@prefix sh: <https://www.w3.org/ns/shacl#> .``
| LOVLink:
...
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/sioc
...
| Namespace: `<https://www.w3.org/ns/oa#>`__
| xmlns: ``@prefix oa: <https://www.w3.org/ns/oa#> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/oa
...
* https://github.com/openannotation/annotator (https://annotatorjs.org/)
...
* "Evolving Schema.org in Practice Pt1: The Bits and Pieces" (2016)
  https://dataliberate.com/2016/02/evolving-schema-org-in-practice-pt1-the-bits-and-pieces/
...
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/schema
...
| Standard: https://www.w3.org/TR/sparql11-update/
| Standard: https://www.w3.org/TR/sparql11-entailment/
| Standard: https://www.w3.org/TR/sparql11-federated-query/

SPARQL is a text-based query and update language
for :ref:`RDF` triples (and quads).

* https://www.w3.org/wiki/SparqlImplementations
* https://www.w3.org/2009/sparql/implementations/#sparql11-entailment
...
| xmlns: ``@prefix ldp: <https://www.w3.org/ns/ldp#> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/ldp

LDP (*Linked Data Platform*) is a standard for building :ref:`HTTP` REST APIs
for :ref:`RDF` :ref:`Linked Data`.

* https://www.w3.org/TR/ldp/#terms
...
| Standard: https://www.w3.org/TR/owl2-overview/
| Standard: https://www.w3.org/TR/owl2-primer/
| Standard: https://www.w3.org/TR/owl2-quick-reference/
| Standard: https://www.w3.org/TR/owl2-profiles/
| xmlns: ``@prefix owl: <https://www.w3.org/2002/07/owl#> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/owl
...
* OWL as :ref:`Turtle`: `<https://www.w3.org/2002/07/owl#>`__
...
PROV
```````
| Homepage: https://www.w3.org/2011/prov/wiki/Main_Page
| Standard: https://www.w3.org/ns/prov.owl
| Standard: https://www.w3.org/TR/prov-overview/
| Standard: https://www.w3.org/TR/prov-primer/
| Standard: https://www.w3.org/TR/prov-o/
| Namespace: `<https://www.w3.org/ns/prov#>`_
| xmlns: ``@prefix prov: <https://www.w3.org/ns/prov#> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/prov
...
DBpedia
``````````
| Homepage: https://wiki.dbpedia.org/Ontology
...
* https://sw.cyc.com/concept/Mx4r7PXDuWpqTcmfojZNIu56eQ
...
| Src: https://github.com/qudt/qudt-public-repo
| Namespace: `<http://qudt.org/2.1/schema/qudt#>`__
| xmlns: ``@prefix qudt: <http://qudt.org/schema/qudt#> .``
| xmlns: ``@prefix qudt-1.1:  <http://qudt.org/1.1/schema/qudt#> .``
| xmlns: ``@prefix qudt-2.1:  <http://qudt.org/2.1/schema/qudt#> .``
| LOVLink: https://lov.linkeddata.es/dataset/lov/vocabs/qudt
...
* QUDT Namespaces:
  ...
  .. code:: n3
      ...
      @prefix qudt-dimension: <http://qudt.org/2.1/vocab/dimensionvector#> .
      @prefix qudt-quantity:  <http://qudt.org/2.1/vocab/quantitykind#> .
...
https://github.com/qudt/qudt-public-repo#overview
...
Semantic Web Tools
---------------------
| Homepage: https://www.w3.org/2001/sw/wiki/Tools
...
| Docs: https://docs.ckan.org/en/latest/maintaining/installing/index.html
| Docs: https://docs.ckan.org/en/latest/maintaining/data-viewer.html
| Docs: https://docs.ckan.org/en/latest/maintaining/paster.html
| Docs: https://docs.ckan.org/en/latest/maintaining/linked-data-and-rdf.html
...
| Homepage: https://webprotege.stanford.edu/
...
| SPARQL: https://lov.linkeddata.es/dataset/lov/sparql
...
LODCloud
+++++++++
| Homepage: https://lod-cloud.net
| Source: git https://github.com/lod-cloud/datahub2void
| Datasets: https://lod-cloud.net/lod-data.json

The LOD ("Linking Open Data") cloud diagram visualizes
the nodes and edges of the *Linked Open Data Cloud*

* https://lod-cloud.net/#history

.. figure:: https://lod-cloud.net/versions/2019-03-29/lod-cloud.png

   :target: https://lod-cloud.net/

You can add datasets to the LODCloud:
